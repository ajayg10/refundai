...
Start the backend and TrueForge services according to their respective configuration.

---

# 🔑 Environment Variables

Configure the required environment variables for the frontend, backend and agent runtime.
